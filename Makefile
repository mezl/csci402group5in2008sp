...
# gmake magic since SunOS /bin/sh does not support */{a,b,c} syntax
clean:
	rm -f $(addprefix */,core nachos DISK *.o swtch.s)
	rm -f test/*.coff
	rm -f $(addprefix bin/,coff2flat coff2noff disassemble out)
